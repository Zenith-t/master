...
export default function Homepage() {
  ...
  const ServiceCard = ({ service, type }: { service: ServiceItem; type: string }) => (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-4 border border-gray-100">
      ...
      <p className="text-blue-600 font-medium text-sm mb-2">{service.specialization}</p>
      ...
      <div className="flex items-center text-gray-600 mb-2">
        ...
        <span className="text-xs">{service.experience} years exp</span>
      </div>
            ...
            <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-50">
              ...
              <button
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      title: 'Zenith Tutors - HealthCare Plus',
