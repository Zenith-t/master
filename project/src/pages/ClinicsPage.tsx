    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold mb-4">Our Clinics</h1>
          <p className="text-xl">Find the best clinics near you</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {clinics.length > 0 ? (
            clinics.map((clinic) => (
              <div key={clinic.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 border border-gray-100">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-600 font-medium mb-2">{clinic.specialization}</p>
                    
                    <div className="flex items-center mb-2">
                      <div className="flex">{renderStars(clinic.rating)}</div>
                      <span className="ml-2 text-sm text-gray-600">
                        ({RatingsCounter.formatCount(RatingsCounter.getRatingCount(clinic.id))} reviews)
                      </span>
                    </div>

                    <div className="flex items-center text-gray-600 mb-2">
                      <Clock className="h-4 w-4 mr-2" />
                      <span className="text-sm">{clinic.experience} years experience</span>
                    </div>
